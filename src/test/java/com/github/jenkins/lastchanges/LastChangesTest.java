...
import static com.github.jenkins.lastchanges.LastChanges.of;
...
public class LastChangesTest {
    ...
    public void shouldBuildLastChangesObject() throws FileNotFoundException {
        LastChanges lastChanges = LastChanges.of(repository(gitRepoPath));
    ...
    @Test
    public void shouldGetLastChangesFromInitialCommitRepo() throws FileNotFoundException {
        ...
        try {
            LastChanges.of(repository(repositoryLocation));
